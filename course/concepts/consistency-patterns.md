...
With multiple copies of the same data, we are faced with options on how to synchronize them so clients have a consistent view of the data.  Recall the definition of consistency from the [CAP theorem](/docs/concepts/availability-vs-consistency) - Every read receives the most recent write or an error.
